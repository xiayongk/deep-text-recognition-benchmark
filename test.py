...
from utils import CTCLabelConverter, AttnLabelConverter, Averager, getChar
...
def validation(model, criterion, evaluation_loader, converter, opt, ignore_idx=[], char_group_idx={}, decoder='greedy', beamWidth=5):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=144, help='input batch size')
